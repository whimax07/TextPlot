...
public class LinePlotTest {
    ...
    public void basicPlot() {
        final List<Double> xData = List.of(10.0, 11.0, 12.0, 13.0, 14.0, 15.0, 16.0, 17.0, 18.0, 19.0, 20.0, 21.0);
        final List<Double> yData = List.of(21.0, 23.0, 15.0, 14.0, 24.0, 25.0, 25.0, 26.0, 27.0, 27.0, 28.0, 27.0);
        final int width = 15;
        final int height = 7;
        final String graph = new LinePlot(xData, yData, width, height, true).draw();
